...
export const COUNTRY_PROFILES = {
  NDC: {
    ...
    strengths: ['Near-max starting political will (100 after home bonus)', 'Clean energy mix already embedded', 'Trusted mediator across EU'],
    challenges: ['Tiny emissions footprint — you must lead, not defeat', 'Small market, limited manufacturing leverage'],
    recommended: 'Invest early in Policy to unlock diffusion-friendly treaties. Your home deployments spread faster — set the standard at home and let Europe follow.',
    bonusLabel: 'Lead by Example — tech you deploy at home spreads 25% faster to neighbors',
    starter: ['wind_power', 'offshore_wind', 'heat_pumps'],
  ...
  DEU: {
    ...
    strengths: ['Strong research base (15% faster research)', 'Industrial capacity to build at scale', 'Central European leverage — four neighbors'],
  ...
  BRA: {
    ...
    writeup: 'The Amazon is the largest intact tropical carbon store on earth, and it is yours to protect. You have hydro-dominant grids and a vibrant, polarized democracy. The forest is your greatest asset and your greatest liability — as it warms, it flips from sink to source.',
    strengths: ['Nature-based removals worldwide run 60% stronger while you lead', 'Hydro-dominant grid from day one', 'Cultural soft power across Latin America'],
    challenges: ['Deforestation pressure from agriculture', 'Amazon dieback risk rises as warming climbs toward tipping points'],
    recommended: 'Land branch is your superpower. Reforestation + Rewilding + Mangroves compound fast. Watch the temperature gauge — you lose the sink before anyone else.',
    bonusLabel: 'Forest Guardian — global nature-based CO₂ removal 60% stronger',
  ...
  USA: {
    ...
    writeup: "The world's second-largest annual emitter, largest in cumulative history, and the most politically volatile climate actor. Every four years the policy regime flips. You have unmatched R&D, venture capital, and manufacturing — and a public that alternates between urgency and denial.",
  ...
  CHN: {
    ...
    writeup: 'One country, nearly a third of global emissions, and the deployment muscle of the industrial revolution compressed into a decade. You build solar panels cheaper than anyone. You also burn more coal than anyone. State capacity is enormous; political will has to be manufactured alongside the hardware.',
  ...
  IND: {
    ...
    writeup: 'You are industrializing and decarbonizing at once — a thing nobody has done before. Cheap solar has bent your curve and electric two-wheelers are outselling petrol in the cities, but 1.4 billion people still need energy that most of them have never had. Coal is entrenched. The sun is free.',
    strengths: ['Home deployments spread 20% faster to neighbors', 'Youth-driven political pressure', 'Solar resource abundance'],
    challenges: ['Energy demand still rising', 'Thermal coal fleet locked in for decades'],
    recommended: 'Energy + Transport. Every solar or EV deploy here ripples across South Asia. Carbon pricing is politically possible earlier here than in petrostates.',
    bonusLabel: 'Monsoon Majority — tech you deploy at home spreads 20% faster to neighbors',
    starter: ['solar_power', 'ev_subsidies'],
  ...
  SAU: {
    ...
    strengths: ['20% more Credits (petrodollar reinvestment)', 'Vision-2030-style top-down execution', 'Gulf bloc influence'],
    challenges: ['Starting political will only 45 (with home bonus)', 'Deep petrostate resistance to Energy and Policy deploys'],
  ...
  RUS: {
    ...
    strengths: ['25% faster research (Soviet engineering legacy)', 'Civilian nuclear fleet intact (Rosatom)', 'Vast land for nature-based solutions'],
    challenges: ['Permafrost methane threat accelerates with warming', 'Political will only 45 at start (with home bonus)', 'Petrostate economic structure resists energy and policy reform'],
